...
for i=1:length(varying_param)
    ...
    param_for_plot(param_index+1:param_index+num_pts) = varying_param(i);
...
writematrix([param_for_plot, vals_for_plot(1:numel(param_for_plot))], 'beta_bifurc_varied_A_5.5pi.csv');